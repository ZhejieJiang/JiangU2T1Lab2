public class ChatBot {
    ...
    //tells how far your number is from 100
    public void one_hundred(int yourNumber) {
        int x = 100 - yourNumber;  // number is an instance variable
        System.out.println("Your number is " + x + " numbers away from 100");

    }
        //Does your taxes (joke)
        public String taxes() {
            return name + ", You really want me to do your taxes? I can't be trusted to do that";
    }
}
